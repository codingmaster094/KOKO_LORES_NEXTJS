...
function Header() {
  ...
  return (
    <header ref={headerRef} className={`${slug === 'brunch' || slug === 'events' ? 's-header' : ''} ${sticky ? "sticky" : ""}`}>
        ...
        <div className="header-wrapper flex items-start gap-3 justify-between md:py-10 sm:py-8 py-6">
          <div className="header-left flex items-start gap-8">
            <div className="logo">
              ...
              {Header_menu && (
                <img 
                src={slug === 'brunch' || slug === 'events' ? Header_menu.header_dark_logo.url : Header_menu.header_light_logo.url} 
                alt={slug === 'brunch' || slug === 'events' ? Header_menu.header_dark_logo.alt :Header_menu.header_light_logo.alt} />
              )}
              </Link>
            </div>
            {Header_menu && (
              ...
              <svg
                ...
                >
                  <path
                    ...
                    fill={slug === "brunch" || slug === "events" ? '#393d47' : '#d7cfc6'}
                  />
                </svg>
              </Link>
